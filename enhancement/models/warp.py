...
def Warp_image(input_images, x_offset, wrap_mode='border', tensor_type = 'torch.FloatTensor'):
    ...
    # print(x.shape)
    # print(y.shape)
    # print("1 shape of X inside loss:",x.shape)
    x = x.view(-1).repeat(1, num_batch)
    # print("2 shape of X inside loss:",x.shape)
    y = y.contiguous().view(-1).repeat(1, num_batch)
    # print("3 shape of X inside loss:",x.shape)
    # print("4 shape of X_offset inside loss:",x_offset.shape)
